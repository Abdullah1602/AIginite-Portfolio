          ...
          <Row style={{ justifyContent: 'center', paddingBottom: '10px' }}>
            ...
            <Col md={4} className="project-card">
              <Card className="project-card-view">
                ...
                <Card.Body>
                  <Card.Title className="highlight">Geographic Loan Analysis Dashboard</Card.Title>
                  <Card.Text style={{ textAlign: "justify" }}>
                  Tableau dashboard dynamically visualizes loan data across geographic and socioeconomic variables. By blending Excel and GeoJSON datasets, it provides a dual-axis map to illustrate regional deprivation levels alongside individual loan details. The dashboard's intuitive design incorporates filters, detailed tooltips, and interactivity, enabling users to easily explore and derive insights from complex loan distributions for informed decision-making.
                  </Card.Text>
                </Card.Body>
              </Card>
            </Col>
