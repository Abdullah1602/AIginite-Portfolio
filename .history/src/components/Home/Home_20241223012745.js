  ...
  return (
    <section className="my-section">
          ...
          <Row>
            <Col md={7} className="home-header">
              ...
              <h1 className="heading-name">
                Our mission is to empower businesses by crafting scalable and intelligent systems{" "} that drive growth and success in a dynamic
                digital world.
              </h1>
            </Col>
      ...
      <section id="about" className="about">
        ...
        <div className="row">
          <div className="content">
            <h3>
              <span className="highlight">Empowering</span> Your Vision with{" "}
              <span className="highlight">Cutting-Edge</span> Technology
            </h3>
            <p>
              We specialize in <span className="highlight">AI</span>,{" "}
              <span className="highlight">Data Engineering</span>,{" "}
              <span className="highlight">Full-Stack Development</span>, and{" "}
              <span className="highlight">Data Analysis</span>, creating
              innovative and scalable solutions. Partner with us to streamline
              operations, solve <span className="highlight">challenges</span>,
              and unlock <span className="highlight">growth</span> in a dynamic
              digital landscape.
            </p>
            <p>
              At <span className="highlight">AIginite Solutions</span>, we are a team of
              <span className="highlight"> innovators</span> and
              <span className="highlight"> problem-solvers</span> dedicated to empowering businesses.
              We craft <span className="highlight"> intelligent solutions</span> that bridge technology and business, driving
              <span className="highlight"> growth</span> and <span className="highlight">transformation</span>.
              Our mission is to help organizations <span className="highlight"> thrive</span>, <span className="highlight">adapt</span>,
              and <span className="highlight">lead</span> in an ever-evolving digital landscape.
            </p>
            <a
      ...
      <section id="services" className="services">
        ...
        <h3>
          Comprehensive <span className="highlight">Solutions</span> Tailored
